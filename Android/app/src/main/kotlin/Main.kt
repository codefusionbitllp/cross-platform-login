...
internal val logger: SkipLogger = SkipLogger(subsystem = "cross.platform.login", category = "CrossPlatformLogin")

private typealias AppRootView = CrossPlatformLoginRootView
private typealias AppDelegate = CrossPlatformLoginAppDelegate
