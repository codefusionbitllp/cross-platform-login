...
struct ContentView: View {
    ...
    var body: some View {
        TabView(selection: $tab) {
            ...
            NavigationStack {
                SettingsView(appearance: $appearance, welcomeName: $welcomeName,  logout: logout)
...
struct ItemListView : View {
    ...
    var body: some View {
        ...
        .navigationDestination(for: Item.self) { item in
            ItemView(item: item).navigationTitle(item.itemTitle)
        }
        .toolbar {
            ToolbarItemGroup {
                Button {
...
struct SettingsView : View {
    ...
    var body: some View {
        Form {
            ...
            HStack {
                PlatformHeartView()
                Text("Modify by [CodeFusionBit](https://codefusionbit.com/)")
            }
